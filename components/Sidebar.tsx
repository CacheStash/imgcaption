  ...
  return (
    <aside className="w-80 border-r border-slate-800 flex flex-col bg-slate-950">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        {/* MOVED: Import Text section now at the top */}
      ...
      <div className="p-4 border-t border-slate-800 text-[10px] text-slate-600 text-center uppercase tracking-widest font-bold">v2.1.1 Pro</div>
    </aside>
  );
};
